...
These scripts separate the published local-paper boundary from later
continuation research-line checks:

| Scope | Script | Purpose |
| --- | --- | --- |
| Published paper | `python reproduce/published_paper.py` | Verify v0.7.4 parent-box descent, v0.9.3 intrinsic ODE, hashes, and the published-paper boundary. |
| Published paper rerun | `python reproduce/published_paper.py --run` | Recompute the v0.7.4 + v0.9.3 theorem pair locally. |
...
published Zenodo paper theorem boundary.
