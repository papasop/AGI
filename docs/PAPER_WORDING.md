...
> The frozen v0.7.4 source, hash-bound inputs, and reproduction instructions
> are archived in the associated GitHub release.

If a DOI is not yet available, cite the GitHub repository and exact release or
commit. Do not retain a placeholder Zenodo bibliographic item that has not
been published.

## Avoid these claims

- “We prove the complete geometric flow.”
- “The projected-gradient ODE is validated.”
- “Gradient alignment is formally certified.”
- “The theorem holds over all ten charts.”
- “A global six-dimensional fibre or holonomy is established.”
