#!/usr/bin/env python3
"""
Projected-gradient response-fibre reconstruction (v0.2.3, 160-step one-click).
...
VERSION = "0.2.3-steps160-oneclick"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="response_fibre_projected_gradient_v0_2_steps160_results",
    )
    parser.add_argument(
