...
TITLE = "C4-E2b LOCAL RECENTERING / AFFINE HANDOFF PREFLIGHT"
VERSION = "0.3.3"
...
def main(argv=None):
    ...
    ap.add_argument("--report", default="/tmp/c4_e2b_local_recenter_affine_handoff_v0_3_3.json")
    ap.add_argument("--candidate", default="/tmp/c4_e2b_local_bridge_candidate_v0_3_3.json")
